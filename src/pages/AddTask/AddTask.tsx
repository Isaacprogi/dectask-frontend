...
const AddTask: React.FC = () => {
  const {  loading, addTask,addTaskForm,setAddTaskForm, error } = useTaskContext()
    ...
    <div className='w-full py-[3rem] flex flex-col items-center px-[1rem]   justify-center'>
      <form onSubmit={handleSubmit} className='w-full  max-w-[40rem]'>
        ...
        <textarea
          ...
          rows={4}
          className='w-full p-2 mb-2 resize-none border border-gray-400  rounded focus:outline-none focus:border-blue-500 focus:ring focus:ring-blue-200'
        ></textarea>
        ...
        <div className='flex gap-[1rem]'>
          ...
          <div>
            ...
            <CustomDatePicker initialDate={new Date()} onDateChange={handleDateChange} />
          </div>
        </div>
        ...
        <div className='w-full flex items-center justify-center mt-[1rem]'>
          <button disabled={loading.addTask} type='submit' className='w-full cursor-pointer bg-neutral-600 hover:bg-neutral-500 max-w-[10rem] mx-auto p-2 text-white rounded'>
            {loading.addTask?<ClipLoader color='white' size={15} />:'Add'}
          </button>
        </div>
      </form>
